...
public class FollowTarget : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Bg2.transform.position = new Vector2(transform.position.x * 0.8f, Bg1.transform.position.y);
        Bg3.transform.position = new Vector2(transform.position.x * 0.6f, Bg1.transform.position.y);
    }
}
